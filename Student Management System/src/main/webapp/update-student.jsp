	...
	<div>
		<div class="container col-md-6">
			<form action="StudentDataController" method="get">
				<div>
					<input type="hidden" name="operation" value="update-student-inDb"/>
				...
				<div class="form-group row">
					<label for="Student-id" class="col-sm-3 col-form-label">Enter
						ID : </label>
					<div class="col-sm-6">
						<input type="text" id="form2Example2" name="id" readonly="readonly"
							class="form-control bg-primary bg-opacity-10" placeholder="ID" required="required" value="${student.id }"/>
					</div>
				</div>
				<br>
				<div class="form-group row">
					<label for="Student-First-Name" class="col-sm-3 col-form-label">Enter
			 		...
			 		<div class="col-sm-6">
						<input type="text" class="form-control" id="inputPassword"
							name="fname" placeholder="First Name" required="required" value="${student.fname}"/>
					</div>
				</div>
				<br>
				<div class="form-group row">
					...
					<div class="col-sm-6">
						<input type="text" class="form-control" id="inputPassword"
							name="lname" placeholder="Last Name" required="required" value="${student.lname}"/>
					</div>
				</div>
				<br>
				<div class="form-group row">
					...
					<div class="col-sm-6">
						<input type="email" class="form-control" id="inputPassword"
							name="email" placeholder="Email Id" required="required" value="${student.email}"/>
					</div>
				</div>
				<br>
				<div>
